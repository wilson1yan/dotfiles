...
vim.keymap.set("n", "<leader>sl", ":AutoSession search<CR>", { silent = true })
...
vim.keymap.set("n", "<M-h>", ":tabmove -1<CR>", { silent = true })
vim.keymap.set("n", "<M-l>", ":tabmove +1<CR>", { silent = true })
